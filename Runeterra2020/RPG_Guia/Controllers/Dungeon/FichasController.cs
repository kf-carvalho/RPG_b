...
namespace RPG_Guia.Controllers.Dungeon
{
    public class FichasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "FichaId,Nome,Antepassado,Tendencia,Personalidade,Ideal,Vinculo,Fraqueza,Caracteristica,Força,Inteligencia,Sabedoria,Destreza,Constituição,Carisma,UsuarioId,TerritorioId,RaçaId,ClasseId")] Ficha ficha)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "FichaId,Nome,Antepassado,Tendencia,Personalidade,Ideal,Vinculo,Fraqueza,Caracteristica,Força,Inteligencia,Sabedoria,Destreza,Constituição,Carisma,UsuarioId,TerritorioId,RaçaId,ClasseId")] Ficha ficha)
        {
            if (ModelState.IsValid)
            {
