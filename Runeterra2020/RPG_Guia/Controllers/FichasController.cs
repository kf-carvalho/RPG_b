...
namespace RPG_Guia.Controllers
{
    public class FichasController : Controller
    {
        ...
        {
            var fichas = db.Fichas.Include(f => f.Classe).Include(f => f.Raça).Include(f => f.Territorio);
        ...
        public ActionResult Create([Bind(Include = "FichaId,Nome_Jogador,Nome_Personagem,Antepassado,Tendencia,TerritorioId,RaçaId,ClasseId")] Ficha ficha)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "FichaId,Nome_Jogador,Nome_Personagem,Antepassado,Tendencia,TerritorioId,RaçaId,ClasseId")] Ficha ficha)
        {
            if (ModelState.IsValid)
            {
